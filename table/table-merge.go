...
// 	destCell := t.grid.CellorPanic(r, c)
...
// 	for j := c + 1; j <= t.grid.Row(r).cellCount(); j++ {
// 		if t.grid.cell(r, j).state == CsMerged { //find the next non-merged cell if any
// 			if debug == types.DebugAll {
// 				fmt.Printf("     skipped cell %d,%d\n", r, j) //DEBUG
// 			}
// 			continue
// 		}
// 		t.grid.cell(r, j).text = srcCell.text
// 		if debug == types.DebugAll {
// 			fmt.Printf("     copied to cell %d,%d\n", r, j) //DEBUG
// 		}
// 		return nil
